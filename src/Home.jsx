...
export default function Home() {
  ...
  return (
    <>
      {/* ===================== NAVBAR =====================
          If your Layout wrapper already renders a navbar, delete this
          <header> block (and its matching CSS) to avoid a duplicate. */}
      <header className="navbar" id="navbar">
        <div className="navbar-inner">
          <a href="#hero" className="brand">
            <img src={logo} alt="NIT Raipur Logo" className="nit-logo" />
            <div className="brand-text">
              <span className="club-name">Aviation Club</span>
              <small>NIT Raipur</small>
            </div>
          </a>

          <nav className="nav-links" id="navLinks" aria-label="Primary navigation">
      ...
      {/* ===================== FOOTER =====================
          If your Layout wrapper already renders a footer, delete this
          block (and its matching CSS) to avoid a duplicate. */}
      <footer className="site-footer">
        <div className="container footer-inner">
          <p>&copy; <span id="year">{year}</span> Aviation Club, National Institute of Technology Raipur. G.E. Road, Raipur - 492010 (C.G.)</p>
        </div>
      </footer>
    </>
  );
